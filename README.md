...
המאגר כולל כרגע התחברות והרשאות, sessions מתמשכים, Weather widget,
Reporter Area, Editor Area, מודלי MongoDB, תיעוד עבודה ו-seed לנתוני הדגמה.
הפיד הציבורי, עמוד הכתבה, תגובות ו-Impact Analytics יושלמו לאחר מיזוג
הענפים של שאר חברי הצוות.
...
הוראות מלאות למסד הנתונים המשותף נמצאות ב-[`docs/mongodb-setup.md`](docs/mongodb-setup.md).
